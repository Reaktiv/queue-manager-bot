...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "uz": {
        ...
        "penalty_notification": "⚠️ {user} \"{task}\" vazifasini muddatida bajarmadi. Jarima ball qo'shildi.",
    ...
    "ru": {
        ...
        "penalty_notification": "⚠️ {user} не выполнил(а) задачу \"{task}\" вовремя. Начислен штрафной балл.",
    ...
    "en": {
        ...
        "penalty_notification": "⚠️ {user} missed the deadline for \"{task}\". A penalty point was added.",
